                ...
                <tbody>
                  @foreach ($brands as $brand)
                    <tr>
                      ...
                      <td>
                         <a class="updateStatus" href="javascript:void(0)" id="brand-{{$brand->id}}" get_id="{{$brand->id}}">
                          @if ($brand->status==1)
                      ...
                      <td>
                        <div class="btn-group" role="group" aria-label="Basic example">
                          <a class="btn btn-sm btn-info" href="{{url('admin/add-edit-brand/'.$brand->id)}}">Edit</a>
                          <a class="btn btn-sm btn-danger confirm-delete" record="brand" recorded="{{$brand->id}}" href="javascript:void(0)">Delete</a>
                        </div>
                      </td>
                      <td></td>
                    </tr>  
