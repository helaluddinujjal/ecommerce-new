                  ...
                  @foreach ($banners as $banner)
                    <tr>
                      ...
                      <td>
                        ...
                        @endphp
                        <img width="150" src="{{$url}}" alt="{{$banner->title?$banner->title:''}}"> 
                      </td>
                      <td>{{$banner->title?$banner->title:''}}</td>
                      <td>{{$banner->link?$banner->link:''}}</td>
                      <td>{{$banner->alt?$banner->alt:''}}</td>
                      <td>
                         <a class="updateStatus" href="javascript:void(0)" id="banner-{{$banner->id}}" get_id="{{$banner->id}}">
                          @if ($banner->status==1)
                      ...
                      <td>
                        <div class="btn-group" role="group" aria-label="Basic example">
                          <a class="btn btn-sm btn-info" href="{{url('admin/add-edit-banner/'.$banner->id)}}">Edit</a>
                          <a class="btn btn-sm btn-danger confirm-delete" record="banner" recorded="{{$banner->id}}" href="javascript:void(0)">Delete</a>
                        </div>
                      </td>
                      <td></td>
                    </tr>  
