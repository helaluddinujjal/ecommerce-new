                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ url('admin/pincode/add-edit-cod') }}" class="btn btn-success float-right">Add
                                    Pincode</a>
                                <div class="mt-5">
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            <a class="btn btn-sm btn-info"
                                                                href="{{ url('admin/pincode/add-edit-cod/' . $pincode->id) }}">Edit</a>
                                                            <a class="btn btn-sm btn-danger confirm-delete"
                                                                record="pincode-cod" recorded="{{ $pincode->id }}"
