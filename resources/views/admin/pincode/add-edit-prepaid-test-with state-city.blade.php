...
@section('content')
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('/admin/pincode/prepaid') }}">Pincode Prepaid List</a></li>
        ...
        <section class="content">
            <form
                @if (!empty($pincodeData->id)) action="{{ url('admin/pincode/add-edit-prepaid', $pincodeData->id) }}"
    @else
    action="{{ url('admin/pincode/add-edit-prepaid') }}" @endif
                    ...
                    <div class="col-md-8 offset-md-2">
                        <div class="card card-secondary">
                            <div class="card-header">
                                <h3 class="card-title">Prepaid Pincode Section</h3>
