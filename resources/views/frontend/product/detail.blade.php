                ...
                <div class="row">
                            ...
                            <ol class="breadcrumb">
                                ...
                                @if (isset($productDetails->section->name) && !empty($productDetails->section->name))
                                    <li class="breadcrumb-item"><a
                                            href="{{ url('/' . $productDetails->section->url) }}">{{ $productDetails->section->name }}</a>
                                    </li>
                                @endif
                                @if (isset($productDetails->category->category_name) && !empty($productDetails->category->category_name))
                                    <li class="breadcrumb-item"><a
                                            href="{{ url('/' . $productDetails->section->url . '/' . $productDetails->category->url) }}">{{ $productDetails->category->category_name }}</a>
                                    </li>
                                @endif
                    ...
                    <div class="col-lg-9 order-1 order-lg-2">
                                ...
                                <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                                    <div class="item">
                                        ...
                                        @if (!empty($productDetails->main_image) && file_exists($image_path))
                                            <img src="{{ asset('images/product/medium/' . $productDetails->main_image) }}"
                                                alt="{{ $productDetails->product_name }}" class="img-fluid">
                                        @else
                                            <img src="{{ asset('images/demo/demo-medium.jpeg') }}"
                                    ...
                                    @if ($productDetails->images->count() > 0)
                                        @foreach ($productDetails->images as $image)
                                            ...
                                            @if (!empty($image->image) && file_exists($image_path))
                                                <div class="item"> <img
                                                        src="{{ asset('images/product/medium/' . $image->image) }}"
                                                        alt="{{ $productDetails->product_name }}" class="img-fluid"></div>
                                            @else
                                                <div class="item"> <img src="{{ asset('images/demo/demo-medium.jpeg') }}"
                                                        alt="{{ $productDetails->product_name }}" class="img-fluid"></div>
                                            @endif
                                        @endforeach
                                    @endif
                            ...
                            <div class="col-md-6">
                                <div class="box">
                                        ...
                                        <div class="mt-2 ml-2">
                                            ...
                                            @foreach ($groupProducts as $groupProduct)
                                                <a href="{{ url('/product/' . $groupProduct->url) }}">
                                                    ...
                                                    @endphp
                                                    @if (!empty($groupProduct->main_image) && file_exists($image_path))
                                                        <img src="{{ asset('images/product/small/' . $groupProduct->main_image) }}"
                                                            alt="{{ $groupProduct->product_name }}" class="img-fluid"
                                                            width="40" height="40">
                                                    @else
                                                        <img src="{{ asset('images/demo/demo-medium.jpeg') }}"
                                                            width="40" height="40"
                                    ...
                                    <p class="price"><span class="attrPrice">
                                            ...
                                            @if ($discount_data['price'] > 0)
                                                <del class="text-danger"
                                                    id="attr_price">{{ settings('site_currency') }}{{ $productDetails->product_price }}</del>
                                                <span id="dis_price">
                                                    {{ settings('site_currency') }}{{ $discount_data['price'] }}</span>
                                                <sup><span class="badge badge-info"
                                                        id="percentage">{{ $discount_data['percentage'] }}</span></sup>
                                            @else
                                                <span
                                                    id="attr_price">{{ settings('site_currency') }}{{ $productDetails->product_price }}</span>
                                            @endif
                                    ...
                                    <p id="hiddenPrice" class="price" style="display:none">
                                        ...
                                        @if ($discount_data > 0)
                                            <del class="text-danger"
                                                id="hidden_attr_price">{{ settings('site_currency') }}{{ $productDetails->product_price }}</del>
                                            <span
                                                id="hidden_dis_price">{{ settings('site_currency') }}{{ $discount_data['price'] }}</span><sup><span
                                                    class="badge badge-info"
                                                    id="hidden_percentage">{{ $discount_data['percentage'] }}</span></sup>
                                        @else
                                            <span
                                                id="hidden_attr_price">{{ settings('site_currency') }}{{ $productDetails->product_price }}</span>
                                        @endif
                                    </p>
                                    <span id="hidden_attr_stock" style="display:none">{{ $totalStock }}</span>
                                    <p class="text-center"><small class="badge badge-secondary"><b
                                                id="attr_stock">{{ $totalStock }}</b> Items in stock</small></p>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select id="getSize" name="size" class="form-control"
                                                    ...
                                                    <input class="form-control ml-1" type="number" name="quantity"
                                                        id="quantity" value="1">
                                ...
                                <div data-slider-id="1" class="owl-thumbs">
                                    <button class="owl-thumb-item">
                                        ...
                                        @endphp
                                        @if (!empty($productDetails->main_image) && file_exists($image_path))
                                            <img src="{{ asset('images/product/small/' . $productDetails->main_image) }}"
                                                alt="{{ $productDetails->product_name }}" class="img-fluid">
                                        @else
                                            <img src="{{ asset('images/demo/demo-medium.jpeg') }}"
                                                alt="{{ $productDetails->product_name }}">
                                    ...
                                    @if ($productDetails->images->count() > 0)
                                        @foreach ($productDetails->images as $image)
                                            <button class="owl-thumb-item">
                                                ...
                                                @endphp
                                                @if (!empty($image->image) && file_exists($image_path))
                                                    <img src="{{ asset('images/product/small/' . $image->image) }}"
                                                        alt="{{ $productDetails->product_name }}" class="img-fluid">
                                                @else
                                                    <img src="{{ asset('images/demo/demo-medium.jpeg') }}"
                                                        alt="{{ $productDetails->product_name }}" class="img-fluid">
                        ...
                        <ul class="nav nav-tabs details gradient">
                            <li class="active"><a data-toggle="tab" class="active nav-link" href="#Details">Details</a>
                            </li>
                                            ...
                                            <tbody>
                                                ...
                                                @if (!empty($productDetails->product_weight))
                                                    <tr>
                                                        <th>Weight</th>
                                                        <td>
                                                            <span id="hidden_attr_weight"
                                                                style="display:none">{{ $productDetails->product_weight }}</span>
                                                            <span
                                                                id="attr_weight">{{ $productDetails->product_weight }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                @endif
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="product same-height">
                                            <div class="flip-container">
                                                <div class="flipper">
                                                    <div class="front"><a
                                                            href="{{ url('/product/' . $relatedPro->url) }}">
                                                            @php
                                                                $image_path = public_path('images/product/small/' . $relatedPro->main_image);
                                                            @endphp
                                                            @if (!empty($relatedPro->main_image) && file_exists($image_path))
                                                                <img src="{{ asset('images/product/small/' . $relatedPro->main_image) }}"
                                                                    alt="{{ $relatedPro->product_name }}"
                                                                    class="img-fluid">
                                                            @else
                                                                <img src="{{ asset('images/demo/demo-small.jpeg') }}"
                                                                    alt="{{ $relatedPro->product_name }}"
                                                                    class="img-fluid">
                                                            @endif
                                                        </a></div>
                                            ...
                                            <a href="{{ url('/product/' . $relatedPro->url) }}" class="invisible">
                                                @if (!empty($relatedPro->main_image) && file_exists($image_path))
                                                    <img src="{{ asset('images/product/small/' . $relatedPro->main_image) }}"
                                                        alt="{{ $relatedPro->product_name }}" class="img-fluid">
                                                @else
                                                    <img src="{{ asset('images/demo/demo-small.jpeg') }}"
                                                        alt="{{ $relatedPro->product_name }}" class="img-fluid">
                                                @endif
                                            ...
                                            <div class="text">
                                                ...
                                                <p class="price">
                                                    ...
                                                    @if ($discount_data['price'] > 0)
                                                        <sup><span
                                                                class="badge badge-info">{{ $discount_data['percentage'] }}</span></sup><del
                                                            class="text-danger">{{ settings('site_currency') }}{{ $relatedPro->product_price }}</del>
                                                        {{ settings('site_currency') }}{{ $discount_data['price'] }}
                                                    @else
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="product same-height">
                                                ...
                                                <div class="flipper">
                                                    <div class="front"><a href="{{ $proViews->url }}">
                                                            ...
                                                            @if (!empty($proDetails->main_image) && file_exists($image_path))
                                                                <img src="{{ asset('images/product/small/' . $proDetails->main_image) }}"
                                                                    alt="{{ $proDetails->product_name }}"
                                                                    class="img-fluid">
                                                            @else
                                                                <img src="{{ asset('images/demo/demo-small.jpeg') }}"
                                                                    alt="{{ $proDetails->product_name }}"
                                            ...
                                            <a href="{{ $proViews->url }}" class="invisible">
                                                @if (!empty($proDetails->main_image) && file_exists($image_path))
                                                    <img src="{{ asset('images/product/small/' . $proDetails->main_image) }}"
                                                        alt="{{ $proDetails->product_name }}" class="img-fluid">
                                                @else
                                                    <img src="{{ asset('images/demo/demo-small.jpeg') }}"
                                                        alt="{{ $proDetails->product_name }}" class="img-fluid">
                                                @endif
                                            ...
                                            <div class="text">
                                                ...
                                                <p class="price">
                                                    ...
                                                    @if ($discount_data['price'] > 0)
                                                        <sup><span
                                                                class="badge badge-info">{{ $discount_data['percentage'] }}</span></sup><del
                                                            class="text-danger">{{ settings('site_currency') }}{{ $proDetails->product_price }}</del>
                                                        {{ settings('site_currency') }}{{ $discount_data['price'] }}
                                                    @else
