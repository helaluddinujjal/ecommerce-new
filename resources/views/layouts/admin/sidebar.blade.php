<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <img src="{{ asset('images/admin/AdminLTELogo.png') }}" alt="AdminLTE Logo"
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                ...
                @if (!empty(Auth::guard('admin')->user()->image))
                    <img src="{{ asset('images/admin/profile/' . Auth::guard('admin')->user()->image) }}"
                        class="img-circle elevation-2" alt="User Image">
                @else
                    <img src="{{ asset('images/admin/user2-160x160.jpg') }}" class="img-circle elevation-2"
                        alt="User Image">
                @endif
            </div>
            <div class="info">
            ...
            with font-awesome or any other icon font library -->
                ...
                <li class="nav-item has-treeview {{ $active }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endphp
                        <li class="nav-item">
                            <a href="{{ url('admin/datepicker/delivery-pickup') }}"
                ...
                <li class="nav-item has-treeview {{ $active }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endphp
                        <li class="nav-item">
                            <a href="{{ url('admin/view-delivery-charges-by-weight') }}"
                                class="nav-link {{ $active }}">
                                <i class="far fa-circle nav-icon"></i>
                ...
                {{-- Pincode --}}
                @php
                    if (Session::get('page') == 'admin-pincode-cod' || Session::get('page') == 'admin-pincode-prepaid') {
                        $active = 'menu-is-opening menu-open';
                    } else {
                        $active = '';
                    }
                ...
                <li class="nav-item has-treeview {{ $active }}">
                    ...
                    <ul class="nav nav-treeview">
                        @php
                            if (Session::get('page') == 'admin-pincode-cod') {
                                $active = 'active';
                            } else {
                                $active = '';
                            }
                        @endphp
                        <li class="nav-item">
                            <a href="{{ url('admin/pincode/cod') }}" class="nav-link {{ $active }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>COD Pincode </p>
                            </a>
                        </li>
                        @php
                            if (Session::get('page') == 'admin-pincode-prepaid') {
                                $active = 'active';
                            } else {
                                $active = '';
                            }
                        @endphp
                        <li class="nav-item">
                            <a href="{{ url('admin/pincode/prepaid') }}"
                                class="nav-link {{ $active }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Prepaid Pincode </p>
                            </a>
